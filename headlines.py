...
WEATHER_URL = 'http://api.openweathermap.org/data/2.5/weather?q={}&units=metric&appid=' + str(OW_API_KEY)
CURRENCY_URL = "https://openexchangerates.org//api/latest.json?app_id=" + str(OE_API_KEY)
